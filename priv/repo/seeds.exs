...
teams = %{
  red_bull: %{name: "Oracle Red Bull Racing", engine: "Honda RBPT", drivers: 
    [
  ...
  aston_martin: %{name: "Aston Martin Aramco Cognizant", engine: "Mercedes", drivers:
    [
  ...
  mercedes: %{name: "Mercedes-AMG PETRONAS F1", engine: "Mercedes", drivers: 
    [
  ...
  ferrari: %{name: "Scuderia Ferrari", engine: "Ferrari", drivers: 
    [
  ...
  alfa_romeo: %{name: "Alfa Romeo F1 Team Stake", engine: "Ferrari", drivers:
    [
      %{first_name: "Valteri", last_name: "Bottas", abbreviation: "BOT", number: 77},
      %{first_name: "Zhou", last_name: "Guanyu", abbreviation: "ZHO", number: 24}
    ]
  },
  alpha_tauri: %{name: "Scuderia AlphaTauri", engine: "Honda RBPT", drivers:
    [
  ...
  wiliams: %{name: "Wiliams Racing", engine: "Mercedes", drivers:
    [
...
teams = Enum.map(teams, fn {key, team} ->
  changeset = Team.changeset(team)

  {key, Repo.insert!(changeset)}
end)

drivers = Enum.reduce(teams, %{}, fn {_, team}, acc ->
  team
...
races = [
  %{
    track: :bahrain,
    date: "2023-03-05",
    positions: ["VER", "PER", "ALO", "SAI", "HAM", "STR", "RUS", "BOT", "GAS", "ALB", "TSU", "SAR", "MAG", "DEV", "HUL", "ZHO", "NOR", "OCO", "LEC", "PIA"]
  },
  %{
    track: :saudi,
    date: "2023-03-19",
    positions: ["PER", "VER", "ALO", "RUS", "HAM", "SAI", "LEC", "OCO", "GAS", "MAG", "TSU", "HUL", "ZHO", "DEV", "PIA", "SAR", "NOR", "BOT", "ALB", "STR"]
  },
  %{
    track: :australia,
    date: "2023-04-02",
    positions: ["VER", "HAM", "ALO", "STR", "PER", "NOR", "HUL", "PIA", "ZHO", "TSU", "BOT", "SAI", "GAS", "OCO", "DEV", "SAR", "MAG", "RUS", "ALB", "LEC"]
  },
  %{
    track: :baku,
    date: "2023-04-30",
...
Enum.reduce(races, %{}, fn params, acc ->
  positions = Enum.with_index(params.positions, fn abbreviation, index ->
